...
export default function EmployeeHistoryPage() {
  ...
  return (
    <div className="min-h-screen pb-24" style={{ backgroundColor: "#fab76b" }}>
      <div
        className="sticky top-0 z-40 border-b border-white/20 px-4 py-4"
        style={{ backgroundColor: "#fab76b" }}
      >
      ...
      <div className="px-4 py-4">
        <div className="flex items-center gap-3 mb-4">
          <div className="rounded-xl bg-white/20 border border-white/20 px-3 py-2 flex-1">
          ...
          <div className="rounded-xl bg-white/20 border border-white/20 px-3 py-2 flex-1">
            <div className="text-xs text-white/70">Entregados</div>
            <div className="text-sm font-bold text-white">
              {deliveredCount}
            </div>
          </div>
        ...
        {filteredOrders.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-white/70">No hay pedidos para esta fecha</p>
          </div>
        ) : (
